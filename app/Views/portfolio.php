...
<html lang="en">
    <head>
        ...
        <title>Muhammad Adif Fikri</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">M Adif Fikri</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Muhammad Adif Fikri</h1>
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Halo, Aku Muhammaad Adif Fikri mahasiswa Informatika Universitas Singaperbangsa Karawang angkatan tahun 2019. Belajar dan mencoba hal baru terutama di bidang teknologi adalah hobi ku</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">Saat ini, aku sedang mendalami pembuatan Web menggunakan Framework PHP Codeigniter 3 dan Codeigniter 4. Info lebih lanjut bisa dilihat di CV ku dibawah ya.<br>Salam Kenal! ⊂(◉‿◉)つ</p></div>
                </div>
